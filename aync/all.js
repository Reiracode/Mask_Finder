...
//JSON  data
var infoData,yourPositon = [23.954635, 120.571868];
//filterdata
var callbackData;
...
function drawMap() {
    ...
    //markerClusterGroup+Customising the Clustered Markers
        ...
        return new Promise((resolve, reject) => {
            if (navigator.geolocation) {
                ...
                const showError = (error) => {  
                    ...
                    //promise.all catch err:User denied Geolocation
                };
...
Promise.all([getMaskInfo(), getYourPosition()])
.then(res => {
...
function filterRange() {
    const result = infoData.filter(item =>getDistance(
  ...
  callback
    ...
    .forEach(({ properties, geometry: { coordinates } }) => {
      ...
      el += `<div class="store_detail">
                    ...
                    <p class="addtolist ${
                      !!typecheck ? "pink" : ""
                    }" ><i class="far fa-check-square"></i></p>
                    <p><i class="fas fa-briefcase"></i>${properties.address}</p>
                    <p><i class="fas fa-phone fa-flip-horizontal"></i><a href="tel:${
                      properties.phone
                    ...
                    <div class="mask_size">
                        <span data-size='adult'>成人${
                          properties.mask_adult
                        }</span>
                        <span data-size='child'>兒童${
                          properties.mask_child
                        }</span>
                    </div> 
